...
image:
  path: /assets/img/opnsense-firewall-homelab.png
...
![Rule ID 100102](/assets/img/rule-100102.png)
...
![Panel created in Grafana for easier visibility](/assets/img/wazuh-in-grafana.png)
